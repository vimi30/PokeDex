package com.example.pokedex.data.network.error

enum class NetworkError(val message: String) : com.example.pokedex.data.network.error.Error {
    ...
    DATABASE_ERROR("An error occurred while getting data from local database. Please try again.")
}